/**
 * @fileOverview Image insertion
 * @author Frank Bardon frankbardon@gmail.com
 * @author Michael Robinson michael@panmedia.co.nz
 */

/**
 * @name $.editor.plugin.image
 * @augments $.ui.editor.defaultPlugin
 * @class Allow the user insert an image
 */
 $.ui.editor.registerPlugin('image', /** @lends $.editor.plugin.image.prototype */ {
    visible: null,
    dialog: null,
    types: {},
    ...
    defaultLinkTypes: [
        ...
        /** @lends $.editor.plugin.link.defaultLinkTypes.page.prototype */ {
             ...
             */
            title: function() {
                return _('Image on this or another website')
            },
             ...
             */
            init: function() {
                console.log('init external image thing')
                return this;
            },
            ...
            show: function(panel, edit) {
            	console.log('show external image thing')
                return this;
            },
            ...
            attributes: function(panel) {
                var attributes = {
                    src: panel.find('input[name="location"]').val()
                };
            ...
            validate: function(panel) {
                console.log('validating the image thing');
                return true;
            }
        }
    ...
    init: function(editor, options) {
        ...
        this.options = $.extend({}, {
            ...
            replaceTypes: false,
            customTypes: [],
            typeDataName: 'uiWidgetEditorImageType',
            dialogWidth: 750,
            dialogHeight: 'auto',
            dialogMinWidth: 670
        }, options);
...
$.ui.editor.registerUi({
    ...
    link: /** @lends $.editor.ui.link.prototype */ {
        ...
        hotkeys: {
            'ctrl+1': {
                'action': function() {
                    this.editor.getPlugin('image').show();
                },
